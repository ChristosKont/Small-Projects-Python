...
class Clock(ActionCounter):
    ...
    def __init__(self, h = 0, m = 0, s = 0):
        ...
        self._m = CyclicCascadeCounter(_________,_________,________)
        self._s = CyclicCascadeCounter(_________,_________,________)
...
class RomanClock(Clock):
    ...
    def __init__(self, h = 0, m = 0, s = 0):
        ...
        self._m = _____________________________________________________
        _______________________________________________________________
        

class AMPMClock(Clock):
    """Roloi opou i endei3i wrwn einai 0 ews 12 me endei3h prwinis wras (AM) 
    'h meshmerianis (PM).
